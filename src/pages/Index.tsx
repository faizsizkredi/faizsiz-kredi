...
import BankFilterTabs from "../components/BankFilterTabs";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-8">
        ...
        <p className="text-gray-600 mb-8">
          Türkiye'deki bankaların güncel faizsiz kredi kampanyalarını karşılaştırın, size en uygun krediye hemen başvurun.
        </p>

        <BankFilterTabs onSortChange={setSortOption} activeTab={sortOption} />
